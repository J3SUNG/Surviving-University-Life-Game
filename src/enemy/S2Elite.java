 ...
 * @author 윤재민
 */
public class S2Elite extends Enemy{
  
    Player target;
    double slope;
    //              x_pos,   y_pos   
    public S2Elite(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float enemySpeed, Player target)
    {
        ...
        unitType = ELITE2;
        checkElite = true;
        icon =  new ImageIcon(".\\src\\image\\enemyImage\\Stage2\\elite.png");
        image = icon.getImage();
        shotIcon = new ImageIcon(".\\src\\image\\enemyImage\\Stage2\\eliteShot.png");
