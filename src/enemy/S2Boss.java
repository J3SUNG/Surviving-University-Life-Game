 ...
 * @author 윤재민
 */
public class S2Boss extends Enemy {
    Player target;
    double slope;
    //              x_pos,   y_pos   
    public S2Boss(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float enemySpeed, Player target)
    {
        ...
        unitType = BOSS2;
        checkBoss = true;
        icon =  new ImageIcon(".\\src\\image\\enemyImage\\Stage2\\boss.png");
        image = icon.getImage();
        shotIcon = new ImageIcon(".\\src\\image\\enemyImage\\Stage2\\bossShot.png");
