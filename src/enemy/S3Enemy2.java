...
import static shootingspaceship.UnitType.STAGE3ENEMY2;

/**
 *
 * @author 윤재민
 */
public class S3Enemy2 extends Enemy{
    Player target;
    double slope;
    double x;
    
    public S3Enemy2(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float enemySpeed, Player target) {
        ...
        point = 60;
        this.target = target;
        unitType = STAGE3ENEMY2;
        icon =  new ImageIcon(".\\src\\image\\enemyImage\\Stage3\\enemy2.png");
        image = icon.getImage();
        sizeX = 60;
        sizeY = 60;
