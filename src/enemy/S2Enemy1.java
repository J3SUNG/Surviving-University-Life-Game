 ...
 * @author 윤재민
 */
public class S2Enemy1 extends Enemy{
    Player target;
    double slope;
    double x;
    
    public S2Enemy1(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float delta_x_inc, Player target) {
        ...
        point = 30;
        this.target = target;
        unitType = STAGE2ENEMY1;
        icon =  new ImageIcon(".\\src\\image\\enemyImage\\Stage2\\enemy1.png");
        image = icon.getImage();
        shotIcon = new ImageIcon(".\\src\\image\\enemyImage\\Stage2\\enemy1Shot.png");
