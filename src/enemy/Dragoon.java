...
public class Dragoon extends Enemy{
    ...
    double slope;
    //              x_pos,   y_pos   
    public Dragoon(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float enemySpeed, Player target)
    {
        ...
        unitType = DRAGOON;
        icon = new ImageIcon(".\\src\\image\\enemyImage\\Stage1\\enemy3.png");
        image = icon.getImage();
        shotIcon = new ImageIcon(".\\src\\image\\enemyImage\\Stage1\\enemy3Shot.png");
