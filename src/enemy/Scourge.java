...
public class Scourge extends Enemy{ 
    ...
    public Scourge(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float enemySpeed, Player target) {
        ...
        this.target = target;
        unitType = SCOURGE;
        icon =  new ImageIcon(".\\src\\image\\enemyImage\\Stage1\\enemy2.png");
        image = icon.getImage();
        sizeX = 60;
        sizeY = 60;
