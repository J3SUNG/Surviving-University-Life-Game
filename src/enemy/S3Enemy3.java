 ...
 * @author 윤재민
 */
public class S3Enemy3 extends Enemy {
  
    Player target;
    double slope;
    //              x_pos,   y_pos   
    public S3Enemy3(int x, int y, float delta_x, float delta_y, int max_x, int max_y, float enemySpeed, Player target)
    {
        ...
        unitType = STAGE3ENEMY3;
        icon =  new ImageIcon(".\\src\\image\\enemyImage\\Stage3\\enemy3.png");
        image = icon.getImage();
        shotIcon = new ImageIcon(".\\src\\image\\enemyImage\\Stage3\\enemy3Shot.png");
